...
def fire_bullets(ai_settings,screen,ship,bullets):
	#Create a new bullet and add in to the bullets group.
...
def update_screen(ai_settings, screen,stats,sb,ship, aliens, bullets,
	...
	#Draw the Home Screen if the game is inactive.
	if not stats.game_active:
		home_screen.draw_home_screen()
...
def check_high_score(stats, sb):
	"""Check to see in ther's a new high score."""
	if stats.score > stats.high_score:
		stats.high_score = stats.score
		sb.prep_high_score()
...
def update_aliens(ai_settings,screen,stats,sb,ship,aliens,bullets):
	"""Check if fleet is at an edge, then update the postions
